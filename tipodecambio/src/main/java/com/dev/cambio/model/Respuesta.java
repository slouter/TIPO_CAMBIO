...
public class Respuesta {
	...
	// datos aplicativos
	@ElementCollection
	private List<DatosRespuesta> datosRespuesta = new ArrayList<DatosRespuesta>();

	// tabla cambio
	@ElementCollection
	private List<TipoCambio> listaCambio = new ArrayList<TipoCambio>();

	public Respuesta() {
	}

	public Respuesta(int x_formato, int x_identificador, int x_codSecuencia, int x_direccion, int x_accion,
			List<DatosRespuesta> datosRespuesta, List<TipoCambio> listaCambio) {
	...
	public List<DatosRespuesta> getDatosRespuesta() {
		return datosRespuesta;
	}

	public void setDatosRespuesta(List<DatosRespuesta> datosRespuesta) {
		this.datosRespuesta = datosRespuesta;
	}
